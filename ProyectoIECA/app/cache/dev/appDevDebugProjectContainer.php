...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'proy', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_d9a41d8567907f79e47232aa34f5fe93');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_d9a41d8567907f79e47232aa34f5fe93');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_d9a41d8567907f79e47232aa34f5fe93');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('C:\\Users\\paola rico\\Documents\\GitHub\\roque\\ProyectoIECA\\src\\principal\\miBundle\\Resources\\config\\doctrine' => 'principal\\miBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'principal\\miBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('miBundle' => 'principal\\miBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app', 'UTF-8');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Users\\paola rico\\Documents\\GitHub\\roque\\ProyectoIECA\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\Users\\paola rico\\Documents\\GitHub\\roque\\ProyectoIECA\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\Users\\paola rico\\Documents\\GitHub\\roque\\ProyectoIECA\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\Users\\paola rico\\Documents\\GitHub\\roque\\ProyectoIECA\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\Users\\paola rico\\Documents\\GitHub\\roque\\ProyectoIECA\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\Users\\paola rico\\Documents\\GitHub\\roque\\ProyectoIECA\\src\\principal\\miBundle/Resources/views', 'mi');
        $instance->addPath('C:\\Users\\paola rico\\Documents\\GitHub\\roque\\ProyectoIECA\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('C:\\Users\\paola rico\\Documents\\GitHub\\roque\\ProyectoIECA\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\Users\\paola rico\\Documents\\GitHub\\roque\\ProyectoIECA\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/Resources/views');
        $instance->addPath('C:\\Users\\paola rico\\Documents\\GitHub\\roque\\ProyectoIECA\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev',
            'kernel.logs_dir' => 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/logs',
            'kernel.bundles' => array(
                ...
                'miBundle' => 'principal\\miBundle\\miBundle',
            ...
            'debug.container.dump' => 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\Users\\paola rico\\Documents\\GitHub\\roque\\ProyectoIECA\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/../web',
            'assetic.write_to' => 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Users/paola rico/Documents/GitHub/roque/ProyectoIECA/app/cache/dev/doctrine/orm/Proxies',
